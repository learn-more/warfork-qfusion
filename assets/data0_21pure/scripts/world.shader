...
{
    qer_editorimage textures/world/sh/slime1.png
    q3map_globaltexture
    surfaceparm trans
    surfaceparm water
    surfaceparm slime
    ...
    { 
            map textures/world/sh/slime2.png
    ...
    { 
            map textures/world/sh/slime1.png
            blendFunc GL_dst_color GL_one
            tcmod scale -.25 -.25
            tcmod scroll .02 .02
    }
...
{
	qer_editorimage textures/colors/blue.png
	surfaceparm noimpact
	surfaceparm nolightmap
	surfaceparm water
	surfaceparm nomarks
...
{
	qer_editorimage textures/world/sh/water2.png
	q3map_globaltexture
	qer_trans .75
	surfaceparm trans
	surfaceparm nonsolid
...
textures/world/bluewater1
{
	...
	{
		map textures/world/sh/pooltint.png
		blendFunc filter
		tcmod scale .5 .5
		tcmod scroll .02 .01
	}
...
textures/world/teleshader1
{
	...
	{
		map textures/world/sh/telefog.png
		blendFunc GL_dst_color GL_one
